...
@interface ZYAttributedConfig : NSObject
 ...
 */
@property (nonatomic, strong) NSArray<ZYAttributedToken*> * tokenPatternConfigs;

/**
 正则属性数组<GAttributedToken>
 */
@property (nonatomic, strong) NSArray<ZYAttributedToken*> * regexPatternConifgs;
